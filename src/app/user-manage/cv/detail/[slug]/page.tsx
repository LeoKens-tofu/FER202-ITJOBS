...
export default async function UserManageCVDetailPage({
  params,
}: {
  params: {
    slug: string;
  ...
  const res = await fetch(
    `${process.env.NEXT_PUBLIC_API_URL}/user/cv/detail/${slug}`,
    {
      method: "GET",
      headers: {
        cookie: cookie || "",
        ...
        <div className="container mx-auto px-[16px]">
          ...
          <div className="border border-[#DEDEDE] rounded-[8px] p-[20px]">
            ...
            <div className="font-[400] text-[16px] text-black mb-[10px]">
              Họ tên:
              <span className="font-[700]">{cvDetail?.fullName}</span>
            </div>
            <div className="font-[400] text-[16px] text-black mb-[10px]">
              Email:
          ...
          <div className="border border-[#DEDEDE] rounded-[8px] p-[20px] mt-[20px]">
            ...
            <div className="font-[400] text-[16px] text-black mb-[10px]">
              Tên công việc:
              <span className="font-[700]">{jobDetail.title}</span>
            </div>
            <div className="font-[400] text-[16px] text-black mb-[10px]">
              Mức lương:
            ...
            <div className="font-[400] text-[16px] text-black mb-[10px]">
              Cấp bậc:
              <span className="font-[700]">{position?.label}</span>
            </div>
            <div className="font-[400] text-[16px] text-black mb-[10px]">
              Hình thức làm việc:
              <span className="font-[700]">{workingForm?.label}</span>
            </div>
            <div className="font-[400] text-[16px] text-black mb-[10px]">
              Công nghệ:
              <span className="font-[700]">
